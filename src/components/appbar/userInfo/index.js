        ...
        >
            <Box className={classes.root}>
                <Box className={classes.infoBox}>
                    <Avatar src={avatarImg} className={classes.avatarImg}></Avatar>
                    <Typography className={classes.nameText}>NicaName</Typography>
                    <Typography className={classes.idText}>Agora:12345</Typography>
                </Box>
                {constacts.includes('userId') ?
                    <Button className={classes.infoBtn} >
                        <img src={newChatIcon} alt='chat' style={{ width: '30px' }} />
                        <Typography className={classes.infoBtnText}>{i18next.t('Chat')}</Typography>
                    </Button> :
                    <Button className={classes.infoBtn} >
                        <img src={addContactIcon} alt='new chat' style={{ width: '30px' }} />
                        <Typography className={classes.infoBtnText}>{i18next.t('Add Contact')}</Typography>
                    </Button>}
            </Box>
        </Popover>
    )
